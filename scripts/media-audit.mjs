...
const visualReview = {
  ...
  'record-facts': { action: 'fountain pen resting on a spiral book', category: 'writing/documentation', status: 'pass' },
  'record-leadership': { action: 'single empty office room with desk and chairs', category: 'place/context', status: 'pass' },
  'record-marketing': { action: 'single office with table and chairs', category: 'place/context', status: 'pass' },
  'record-journeys': { action: 'rubber stamp and stationery arranged on a table', category: 'writing/documentation', status: 'pass' },
  'record-federal': { action: 'vintage rubber stamps and plaques on display', category: 'writing/documentation', status: 'pass' },
  'record-verify': { action: 'smartphone and financial charts on a desk', category: 'analysis/review', status: 'pass' },
  'record-files': { action: 'stacks of paper documents and file folders', category: 'analysis/review', status: 'pass' },
  'record-nav': { action: 'single conference room with table and chairs', category: 'place/context', status: 'pass' },
  'record-metrics': { action: 'calculator on a table next to a laptop', category: 'analysis/review', status: 'pass' },
  'record-screens': { action: 'single laptop computer on a table', category: 'technical build', status: 'pass' },
  'record-ops': { action: 'computer keyboard and mouse on a desk', category: 'technical build', status: 'pass' },
  'record-style': { action: 'pencil resting on a book in shallow focus', category: 'writing/documentation', status: 'pass' },
