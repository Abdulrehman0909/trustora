...
const visualReview = {
  ...
  'record-facts': { action: 'collaborating around a table with laptops', category: 'conversation/networking', status: 'pass' },
  'record-leadership': { action: 'team collaborating in a modern office', category: 'conversation/networking', status: 'pass' },
  'record-marketing': { action: 'professionals collaborating in an office meeting', category: 'conversation/networking', status: 'pass' },
  'record-journeys': { action: 'two people shaking hands', category: 'conversation/networking', status: 'pass' },
  'record-federal': { action: 'place/context view of office towers', category: 'place/context', status: 'pass' },
  'record-verify': { action: 'reviewing financial documents and charts', category: 'analysis/review', status: 'pass' },
  'record-files': { action: 'reviewing documents at a table', category: 'analysis/review', status: 'pass' },
  'record-nav': { action: 'place/context view of an open office', category: 'place/context', status: 'pass' },
  'record-metrics': { action: 'presenting during a meeting with a laptop', category: 'presentation/facilitation', status: 'pass' },
  'record-screens': { action: 'working at a laptop on a desk', category: 'technical build', status: 'pass' },
  'record-ops': { action: 'working at desks in an open-plan office', category: 'coordination/logistics', status: 'pass' },
  'record-style': { action: 'reviewing a colour reference book', category: 'analysis/review', status: 'pass' },
